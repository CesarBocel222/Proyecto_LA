        ...
        do
        {
            ...
            if (gramatica.Count > 0)
            {
                ...
                if (al.getTokens() != null)
                {
                    ...
                    //  TODO: Esto de python
                    var InfoMetodos = new InfoMetodosVM()
                    {
                        Sets = al.getSets(),
                        Simbolos = expressionTree.SimbolosTerminales,
                        Reservadas = al.getReservadas(),
                        Tokens = expressionTree.SymbolsToInfoVM(parametros.Expresion),
                        EstadosAceptacion = expressionTree.EstadosAceptacion,
                        EstadosVM = expressionTree.EstadosVMov
                    };
                    expressionTree.AlmacenarSimbolos();
                    GeneradorCodigo generadorCodigo = new GeneradorCodigo(InfoMetodos);
